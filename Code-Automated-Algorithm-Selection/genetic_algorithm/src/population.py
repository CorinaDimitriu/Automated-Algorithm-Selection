...
from genetic_algorithm.src.utils import array_of_ones_and_zeros
...
def create_starting_population(population_size, max_width, rectangles, genes, fitness_fuction, it_rotates, seed):
    return np.array(
        [create_random_individual(genes, max_width, rectangles, fitness_fuction, it_rotates, _ + seed) for _ in
