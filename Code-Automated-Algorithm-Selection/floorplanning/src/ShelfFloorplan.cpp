...
void ShelfFloorplan::bin_shelf_next_fit_floorplanning(vector<int>& w, vector<int>& h, vector<int>& indices) {
    ...
    string logfile = "D:/Facultate/Semestrul_2_Master/AEA/Code-Automated-Algorithm-Selection/floorplanning/log/shelfNF-" + to_string(numBlocks) + "b-" + sorting_type;
    if (guillotine) {
        logfile += "-guillotine-";
...
void ShelfFloorplan::bin_shelf_first_fit_floorplanning(vector<int>& w, vector<int>& h, vector<int>& indices) {
    ...
    string logfile = "D:/Facultate/Semestrul_2_Master/AEA/Code-Automated-Algorithm-Selection/floorplanning/log/shelfFF-" + to_string(numBlocks) + "b-" + sorting_type;
    if (guillotine) {
        logfile += "-guillotine-";
        logfile += gspace.enum_to_string(gh);
    }
...
void ShelfFloorplan::bin_shelf_best_width_fit_floorplanning(vector<int>& w, vector<int>& h, vector<int>& indices) {
    ...
    string logfile = "D:/Facultate/Semestrul_2_Master/AEA/Code-Automated-Algorithm-Selection/floorplanning/log/shelfBWF-" + to_string(numBlocks) + "b-" + sorting_type;
    if (guillotine) {
        logfile += "-guillotine-";
        logfile += gspace.enum_to_string(gh);
    }
...
void ShelfFloorplan::bin_shelf_best_height_fit_floorplanning(vector<int>& w, vector<int>& h, vector<int>& indices) {
    ...
    string logfile = "D:/Facultate/Semestrul_2_Master/AEA/Code-Automated-Algorithm-Selection/floorplanning/log/shelfBHF-" + to_string(numBlocks) + "b-" + sorting_type;
    if (guillotine) {
        logfile += "-guillotine-";
        logfile += gspace.enum_to_string(gh);
    }
...
void ShelfFloorplan::GuillotineShelf(Shelf& shelf) {
    ...
    for (size_t i = 0; i < shelf.existing_blocks.size(); i++) {
        ...
        Rectangle rect = {
            old_rect.x,
            old_rect.y + old_rect.h,
            old_rect.w,
            shelf.shelf_H - old_rect.h
        };
