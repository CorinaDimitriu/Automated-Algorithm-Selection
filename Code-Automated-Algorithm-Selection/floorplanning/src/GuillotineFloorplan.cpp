...
void GuillotineFloorplan::SplitFreeRectByHeuristic(const Rectangle& free_rect, const Rectangle& placed_rect) {
    ...
    Rectangle bottom = {
        free_rect.x,
        free_rect.y + placed_rect.h,
        (split_horizontal) ? free_rect.w : placed_rect.w,
        free_rect.h - placed_rect.h
    };
    Rectangle right = {
        free_rect.x + placed_rect.w,
        free_rect.y,
        free_rect.w - placed_rect.w,
        (split_horizontal) ? placed_rect.h : free_rect.h
    };
